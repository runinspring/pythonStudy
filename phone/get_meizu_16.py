...
def setData(datas):
    ...
    cursor = db.cursor()
    sql = "INSERT INTO cm_meizu_16 (id, guid,content,creationTime,referenceName,userImageUrl,nickname,memery,userLevelName) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s) "
...
def getURL():
    ...
    if idx > 5:
        return
    print('url page:', idx)
    url = 'https://sclub.jd.com/comment/productPageComments.action?&productId=8535863&score=0&sortType=6&page=%s&pageSize=10&isShadowSku=0&rid=0&fold=1' % idx
